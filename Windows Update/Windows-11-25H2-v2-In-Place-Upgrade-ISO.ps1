$dir = "C:\Windows\AdminArsenal\win11"
New-Item -ItemType Directory -Path $dir -Force | Out-Null

# Paths

$logFile   = Join-Path $dir "Upgrade.log"
$isoFile   = Join-Path $dir "Win11_25H2_English_x64_v2.iso"
$logFolder = Join-Path $dir "Win11UpgradeLogs"

# Download Latest Windows 11 ISO

$webClient = New-Object System.Net.WebClient
$url = 'https://isos.asti-usa.com/ITDept/Windows%2011/Win11_25H2_English_x64_v2.iso'
...
if (-not $driveLetter) {
    Write-Output "[$(Get-Date)] Error: Could not determine mounted ISO drive letter." | Tee-Object -FilePath $logFile -Append
    exit 1
}
...
$arguments = "/auto upgrade /bitlocker alwayssuspend /quiet /eula accept /dynamicupdate disable /copyLogs `"$logFolder`""
...
switch ($exitCode) {
    ...
    -2147185721 { Write-Output "[$(Get-Date)] Error: Setup failed – generic failure." | Tee-Object -FIlePath $logFile -Append }
